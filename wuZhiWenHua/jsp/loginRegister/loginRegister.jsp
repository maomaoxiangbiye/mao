...
<html>
  ...
  <body style="background-image: url(images/mm.jpg);background-size:100% 100%;">
	<div class="login_cont">
		<div class="login_nav">
			...
			<div class="input_signup">
				...
				<select class="input" id="user_role" style="width:300px;height:38px;">
			...
			<div class="input_signin  active">
				...
				<select class="input" id="login_role" style="width:300px;height:38px;">
					<option value="1">管理员</option>
					<option value="2">用户</option>
				</select>
