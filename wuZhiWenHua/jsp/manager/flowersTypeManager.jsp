   		...
   		<div class="titleBox">
   			<div class="atrContent">
   			   	<div class="col-sm-2 floatLeft">
   					<input type="text" id="userDescribe" style="height: 34px" placeholder="请输入商品类型名称">
	   			</div>
...
<!--		<div id="gridBoxPage"></div>-->
    ...
    <script type="text/javascript" src="js/manager/flowersTypeManager.js"></script>    
